package software.amazon.ec2capacityreservationfleet.capacityreservationfleet;
    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(request.getDesiredResourceState(), callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-EC2CapacityReservationFleet-CapacityReservationFleet::Update::PreUpdateCheck", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-EC2CapacityReservationFleet-CapacityReservationFleet::Update::first", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                    ...
                    proxy.initiate("AWS-EC2CapacityReservationFleet-CapacityReservationFleet::Update::second", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
